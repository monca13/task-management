...
@section('content')
    <div class="container">
        ...
        <div class="col-lg-12 offset-6 form" style="margin: auto;">
            <h2>EDIT TASK</h2>
            <hr>
            <form method="post" action="{{url('task/edit').'/'.$task->id}}" id="edit">
                @method('PUT')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="description" name="description" value="{{$task->description}}" placeholder="Enter Description of Task" required>
